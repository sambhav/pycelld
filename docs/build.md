...
require `monty-application-policy-v1`; the runtime also advertises
`monty-native-v1`, `monty-modules-v1`, `monty-filesystem-v1`,
`monty-network-policy-v1`, `monty-execution-v1`, `monty-observability-v1` and `monty-http-v1`, and continues loading older single-file
...
- `0007-application-policies.patch`: live operator policies, application mappings,
  and per-invocation host limit snapshots.
